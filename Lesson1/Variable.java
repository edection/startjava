public class Variable {
	public static void main(String[] args) {
		...
		System.out.println("smbiosVersion = " + smbiosVersion);
		System.out.println("email = " + email);
		System.out.println("checkEthernet = " + checkEthernet);
		System.out.println("checkWifi = " + checkWifi);
	}
}